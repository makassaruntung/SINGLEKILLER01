...
ks = LINETCR.LINE() #SK5
ks.login(token="EqIk0wQvg4qmBJLMdAR7.YVFeknG7Kyrgeu8INzT6TW.UWicRlvexMZ72GmcB28ywnPTtQjH0StkagdXK/L+5ak=")
ks.loginResult()
...
ร͓͓͓͓̽̽̽̽เ͓͓͓͓̽̽̽̽ɳ͓͓͓͓̽̽̽̽ɠ͓͓͓͓̽̽̽̽ℓ͓͓͓͓̽̽̽̽ε͓͓͓͓̽̽̽̽ ͓̽ҡ͓͓͓͓̽̽̽̽เ͓͓͓͓̽̽̽̽ℓ͓͓͓͓̽̽̽̽ℓ͓͓͓͓̽̽̽̽ε͓͓͓͓̽̽̽̽૨͓͓͓͓̽̽̽̽ ͓̽ɓ͓͓͓͓̽̽̽̽σ͓͓͓͓̽̽̽̽ƭ͓͓͓͓̽̽̽̽ ͓̽ρ͓͓͓͓̽̽̽̽૨͓͓͓͓̽̽̽̽σ͓͓͓͓̽̽̽̽ƭ͓͓͓͓̽̽̽̽ε͓͓͓͓̽̽̽̽૮͓͓͓͓̽̽̽̽ƭ͓͓͓͓̽̽̽̽
...
S҉ ҉҉  ҉ K҉ ҉҉  ҉  ҉ T҉ ҉҉  ҉ E҉ ҉҉  ҉ A҉ ҉҉  ҉ M҉ ҉҉  ҉  ҉ B҉ ҉҉  ҉ O҉ ҉҉  ҉ T҉ ҉҉  ҉ 
...
Minat? Silahkan PM!
Idline: http://line.me/ti/p/~fxsfamilia""",
    "lang":"JP",
...
def bot(op):
        ...
        if op.type == 13:
          if wait["Protectcancl"] == True:
            ...
            if op.param2 in admin:
              ...
              random.choice(KAC).sendText(op.param1, "Mau Ngundang siapa luh?\nKk admin aja bukan luh\n gua cancell yahho😛")
        ...
        if op.type == 13:
            if mid in op.param3:
              if wait["autoJoin"] == True:
                ...
                print "Aktifin dulu auto joinnys Gblk"
            ...
            if Amid in op.param3:
              if wait["autoJoin"] == True:
                ...
                print "Aktifin dulu auto joinnya Gblk"
    ...
    #--------------------------------------
    #-------------- Add Friends ------------
            elif "SK Add @" in msg.text:
              if msg.toType == 2:
                if msg.from_ in owner:
                  print "[Command]Add executing"
                  _name = msg.text.replace("SK Add @","")
                  _nametarget = _name.rstrip('  ')
                  gs = cl.getGroup(msg.to)
                  gs = ki.getGroup(msg.to)
                  gs = kk.getGroup(msg.to)
